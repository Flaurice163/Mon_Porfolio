import { CodeXmlIcon, Facebook, Github, Linkedin, Twitter } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-5 py-12">
        <div className="grid gap-10 lg:grid-cols-[1.6fr_1fr_1fr] items-start">
          <div className="space-y-5">
            ...
            <h3 className="text-sm uppercase tracking-[0.2em] text-warning mb-5">Suivez-nous</h3>
            <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="#Home" className="transition hover:text-warning">Accueil</a>
              </li>
              <li>
                <a href="#Services" className="transition hover:text-warning">Services</a>
              </li>
              <li>
                <a href="#About" className="transition hover:text-warning">À propos</a>
              </li>
              <li>
                <a href="#Projects" className="transition hover:text-warning">Projets</a>
              </li>
              <li>
                <a href="#Contact" className="transition hover:text-warning">Contact</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-slate-400">
              ...
              <a href="https://wa.me/261343461787?text=Bonjour%2C%20je%20souhaite%20discuter%20d%27un%20projet%20web" target="_blank" rel="noopener noreferrer" className="block hover:text-warning transition text-slate-400">
                WhatsApp +261 34 34 617 87
              </a>
